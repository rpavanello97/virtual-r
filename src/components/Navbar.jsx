 ...
 * navigation links, and account action links. The component includes a
 * toggleable mobile drawer for smaller screens.
 *
 * @returns {JSX.Element} A navigation bar with links and logo.
 */
const Navbar = () => {
